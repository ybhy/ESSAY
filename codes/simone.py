...
texts = [line.strip() for line in file('read3000.txt')]
...
lsi = models.LsiModel(corpus_tfidf, id2word=dictionary, num_topics=115)
...
for i in xrange(len(texts)):
	...
	for line in sort_sims[0:length]:
		...
		if(i >= 0 and i < 600):
			if(line[0] >= 0 and line[0] < 600):
				precise = precise + 1
		elif(i>= 600 and i < 1200):
			if(line[0] >= 600 and line[0] < 1200):
				precise = precise + 1
		elif(i>= 1200 and i < 1800):
			if(line[0] >= 1200 and line[0] < 1800):
				precise = precise + 1
		elif(i>= 1800 and i < 2400):
			if(line[0] >= 1800 and line[0] < 2400):
				precise = precise + 1
		else:
			if(line[0] >= 2400 and line[0] < 3000):
				precise = precise + 1
